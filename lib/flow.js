...
module.exports = Flow = (function() {
  ...
  Flow.prototype._find_dependency = function(parent) {
    var fluid, route;
    fluid = _.find(this.actives, function(f) {
      return f.url === parent.dependency;
    });
    if (fluid != null) {
      return fluid;
    }
    route = _.find(this.router.routes, function(r) {
  ...
  Flow.prototype.filter_deads = function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      fluid = _ref[_i];
      is_pending = _.find(this.pendings, function(f) {
  ...
  Flow.prototype.run_pendings = function(url, done) {
    ...
    is_active = _.find(this.actives, function(f) {
      return f.url === fluid.url;
    });
    if (is_active) {
  ...
  Flow.prototype.destroy_deads = function(done) {
    ...
    this.actives = _.reject(this.actives, function(f) {
      return f.url === fluid.url;
    });
